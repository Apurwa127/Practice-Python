...
# student_scores.update({"Frank": 78})
...
# for name, answer in capitals.items():
#     swapped[answer] = name
# print(swapped)

# student_info = { "apu" : 123,
#                 "mike" : 234,
#                 "Henry":456
...
# empty_dict = {}
# print(student_info)
# student_info.update({"bob":567})
# student_info["harry"] = 789
# print(student_info)

# for name, stu_id in student_info.items():
#     empty_dict[stu_id] = name
# print(empty_dict)
...
# scores = {"Alice":85,"Bob":92,"Charlie":78,"David":88, "Eve":95}
...
# fruits = ["apple", "pears", "grapes", "strawberry"]
